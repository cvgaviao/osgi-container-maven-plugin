...
public abstract class AbstractOsgiContainerTest {
    ...
    public AbstractOsgiContainerTest() {
    }
    ...
    protected Xpp3Dom newParameterMavenArtifactsSets(Xpp3Dom... mavenArtifactSets) {
        final Xpp3Dom artifactSetCollection = new Xpp3Dom("mavenArtifactSets");
        for (Xpp3Dom artifactset : mavenArtifactSets) {
            artifactSetCollection.addChild(artifactset);
        }
        return artifactSetCollection;
    }
